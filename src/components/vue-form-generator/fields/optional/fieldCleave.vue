<template>
<input class="form-control" type="text" :value="value" :autocomplete="schema.autocomplete" :disabled="disabled" :placeholder="schema.placeholder" :readonly="schema.readonly" :name="schema.inputName" :id="getFieldID(schema)"/>
</template>

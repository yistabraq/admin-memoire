<template>
  <div class="vue-form-generator" v-if="schema != null">
	  <div v-if="schema.fields" :is="tag">
			<template v-for="field in fields">
				<form-group v-if="fieldVisible(field)" :vfg="vfg" :field="field" :errors="errors" :model="model" :options="options" @validated="onFieldValidated" :key="field"></form-group>
			</template>
		</div>
  </div>
</template>
